...
import static com.test.backend.developer.test_backend_nahuel.utils.Queries.FIND_TECHNOLOGY_NAME;
...
public interface TechnologyRepository extends JpaRepository<Technology, Long> {
    ...
    @Query(value = FIND_TECHNOLOGY_NAME, nativeQuery = true)
    Technology findByName(String technology);
}
